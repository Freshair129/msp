...
>
> Full narrative: [`packages/msp/docs/UNIVERSAL-CONTEXT-FRAMEWORK_spec.md`](../../docs/UNIVERSAL-CONTEXT-FRAMEWORK_spec.md).
...
- `packages/msp/docs/UNIVERSAL-CONTEXT-FRAMEWORK_spec.md` §0–§2, §10 — narrative SSOT.
- `packages/msp/gks/frame/FRAME--MSP-ARCHITECTURE-V2.md` — parent architecture.
- `packages/msp/gks/concept/CONCEPT--COGNITIVE-LAYER-FACADE.md` — the entry point that surfaces this FRAME.
