...
tags:
  ...
  - knowledge-base
  - dogfood
crosslinks: {"references":["FRAME--MSP-ARCHITECTURE","FRAME--PHASE-GOVERNANCE","FRAME--SCALING-LEVELS","FRAME--AUTHORITY-MATRIX","FRAME--CROSSLINKS-VOCABULARY","CONCEPT--INBOUND-QUEUE","CONCEPT--ATOMIC-WRITE-CONTRACT","CONCEPT--CODEGEN-MICROTASK-CONTRACT","CONCEPT--MEMORY-SUBSYSTEM","ADR--PROMOTION-WORKFLOW","FEAT--CODEGEN-MICROTASK-RUNNER","FEAT--MEMORY-SESSIONS-WRITER","FEAT--MEMORY-EPISODIC-WRITER","FEAT--MEMORY-BACKLINKS-INDEXER"]}
created_at: 2026-05-03T07:17:57.396Z
---
...
| Spec section | Atoms |
|---|---|
| §2 Architecture | `FRAME--MSP-ARCHITECTURE` |
...
- `FRAME--MSP-ARCHITECTURE` (root of the knowledge tree)
