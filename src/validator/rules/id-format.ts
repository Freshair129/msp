...
// UPPERCASE letters, digits, hyphens and underscores. We extend with the
// numeric ADR-NNN form referenced in msp_spec.md §4.4.
export const ID_PATTERN =
  /^(?:ADR-\d{3}|[A-Z][A-Z0-9_]*--[A-Z0-9][A-Z0-9_-]*)$/
